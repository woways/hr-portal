...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0B1929] text-center px-6">
      ...
      <Link href="/login" className="mt-6 inline-flex items-center gap-2 bg-[#14B8A6] text-white px-5 py-2.5 rounded-full text-sm font-semibold hover:bg-[#0f9488] transition-colors">
        Go to Login
      </Link>
    </div>
  );
